...
namespace Sistratur.Modelos.Modelos
{
    public class Cliente
    {
        ...
        [MinLength(8, ErrorMessage = "Verifique el número de dígitos.")]
        [MaxLength(11, ErrorMessage = "Verifique el número de dígitos.")]
        ...
        [MaxLength(9)]
        [MinLength(6)]
        [RegularExpression("^[0-9]{6}$", ErrorMessage = "El campo teléfono debe ser de 6 dígitos como mínimo.")]
